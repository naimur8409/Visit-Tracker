        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="mr-2">Ringer Soft LTD</h1>
                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Add-User"></i>
                                <div class="content">
                                    <p class="text-muted mt-2 mb-0">Total Client</p>
                                    <p class="text-primary text-24 line-height-1 mb-2">{{$total_client}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Checkout-Basket"></i>
                                <div class="content">
                                    <p class="text-muted mt-2 mb-0">Total Visit</p>
                                    <p class="text-primary text-24 line-height-1 mb-2">{{$total_visit}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ul-widget1">
                        <div class="ul-widget__item">
                            <div class="ul-widget__info">
                                <h3 class="ul-widget1__title">Total TA / DA</h3><span class="ul-widget__desc text-mute">Total Travelling Allowance & Dearness Allowance</span>
                            </div><span class="ul-widget__number text-primary">{{$total_td}} Taka</span>
                        </div>
                        <div class="ul-widget__item">
                            <div class="ul-widget__info">
                                <h3 class="ul-widget1__title">Paid TA / DA</h3><span class="ul-widget__desc text-mute">Paid Travelling Allowance & Dearness Allowance</span>
                            </div><span class="ul-widget__number text-success">{{$paid_td}} Taka</span>
                        </div>
                        <div class="ul-widget__item">
                            <div class="ul-widget__info">
                                <h3 class="ul-widget1__title">Pending TA / DA</h3><span class="ul-widget__desc text-mute">Pending Travelling Allowance & Dearness Allowance</span>
                            </div><span class="ul-widget__number text-danger">{{$pending_td}} Taka</span>
                        </div>
                    </div>
                    <!-- end::widget-stats-1-->
                </div
